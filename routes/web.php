...
Route::get('/schedule', function () {    return view('edumate.schedule'); })->name('schedule');
Route::get('/session', function () {    return view('edumate.session'); })->name('session');

Route::get('/admission', function () {    return view('edumate.admission.index'); })->name('admission');
