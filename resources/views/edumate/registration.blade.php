            ...
            <div class="row w-90 m-auto">
                <div class="notice-content">
                    <div class="single-notice">
                        ...
                        <p>Для офомлення екзаменаційного листка вам необхідно заповнити <b><u><a href="{{ asset('documents/statement/Zayava-anketa_YEVI_YEFVV_2023.pdf') }}">ЗАЯВУ-АНКЕТУ</a></u></b> та прислати на
