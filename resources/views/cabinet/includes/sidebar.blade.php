<div class="scroll-sidebar">
    ...
    <div class="user-profile position-relative"
         style="background: url(/cabinet/images/background/user-info.jpg) no-repeat;">
        <!-- User profile image -->
        <div class="profile-img"><img src="{{asset('/')}}/cabinet/images/users/profile.png" alt="user" class="w-100"/></div>
        <!-- User profile text-->
    ...
    <nav class="sidebar-nav">
        <ul id="sidebarnav">
            <li class="nav-small-cap">
                ...
                <span class="hide-menu">База даних</span>
            </li>

            <li class="sidebar-item">
                <a class="sidebar-link has-arrow waves-effect waves-dark" href="javascript:void(0)" aria-expanded="false">
                    <i class="mdi mdi-account"></i>
                    <span class="hide-menu">Структура </span>
                </a>
                <ul aria-expanded="false" class="collapse  first-level">
                    <li class="sidebar-item">
                        <a href="{{route('admin.cathedras.index')}}" class="sidebar-link">
                            <i class="mdi mdi-adjust"></i>
                            <span class="hide-menu">Кафедри</span>
                        </a>
                    </li>
                    <li class="sidebar-item">
